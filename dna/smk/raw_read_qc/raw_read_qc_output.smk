...
path_qc_report += expand(
    [path_data + "raw_read_qc/fastqc/{u.case}/{u.sample}/{u.case}_{u.sample}_{u.unit}_1_fastqc.zip"],
    u=caseinfo.itertuples()) + expand(
    [path_data + "raw_read_qc/fastqc/{u.case}/{u.sample}/{u.case}_{u.sample}_{u.unit}_2_fastqc.zip"],
    u=caseinfo.itertuples()) + expand(
    [path_data + "raw_read_qc/" + trim_method + "_fastqc2/{u.case}/{u.sample}/{u.case}_{u.sample}_{u.unit}_" +
     trim_method + "_fastqc2_1.zip"], u=caseinfo.itertuples()) + expand(
    [path_data + "raw_read_qc/" + trim_method + "_fastqc2/{u.case}/{u.sample}/{u.case}_{u.sample}_{u.unit}_" +
     trim_method + "_fastqc2_2.zip"], u=caseinfo.itertuples()) + expand(
    [path_data + "raw_read_qc/" + trim_method + "/{u.case}/{u.sample}/{u.case}_{u.sample}_{u.unit}_" +
     trim_method + ".json"],
    u=caseinfo.itertuples())
path_clean_reads = expand([path_data + "cleandata/" + trim_method +
                           "/{u.case}/{u.sample}/{u.case}_{u.sample}_{u.unit}_" +
