...
rule loadrawData:
    ...
    log:
       path_log + "raw_read_qc/loadRawdata/{case}/{sample}/{case}_{sample}_{unit}_loaddata.log"
    benchmark:
             path_bm + "raw_read_qc/loadRawdata/{case}/{sample}/{case}_{sample}_{unit}_loaddata.tsv"
    params:
          ""
    run:
        inR1 = input.R1
...
rule fastqc:
    input:
         ...
         R2=path_data + "rawdata/{case}/{sample}/{case}_{sample}_{unit}_2.fq.gz"
    output:
          tmp_dir=directory(path_data + "raw_read_qc/fastqc/{case}/{sample}/{case}_{sample}_{unit}/"),
          html1=path_data + "raw_read_qc/fastqc/{case}/{sample}/{case}_{sample}_{unit}_1_fastqc.html",
          html2=path_data + "raw_read_qc/fastqc/{case}/{sample}/{case}_{sample}_{unit}_2_fastqc.html",
          zip1=path_data + "raw_read_qc/fastqc/{case}/{sample}/{case}_{sample}_{unit}_1_fastqc.zip",
          zip2=path_data + "raw_read_qc/fastqc/{case}/{sample}/{case}_{sample}_{unit}_2_fastqc.zip"
    log:
       path_log + "raw_read_qc/fastqc/{case}/{sample}/{case}_{sample}_{unit}_fastqc.log"
    threads: config["threads"]["fastqc"]
    benchmark:
             path_bm + "raw_read_qc/fastqc/{case}/{sample}/{case}_{sample}_{unit}_fastqc.tsv"
    params:
          path=path_fastqc,
          extra=""
    run:
...
rule fastp:
    ...
    output:
          ...
          html=path_data + "raw_read_qc/fastp/{case}/{sample}/{case}_{sample}_{unit}_fastp.html",
          json=path_data + "raw_read_qc/fastp/{case}/{sample}/{case}_{sample}_{unit}_fastp.json"
    log:
       path_log + "raw_read_qc/fastp/{case}/{sample}/{case}_{sample}_{unit}_fastp.log"
    threads: config["threads"]["fastp"]
    params:
          path=path_fastp,
          extra=""
    benchmark:
             path_bm + "raw_read_qc/fastp/{case}/{sample}/{case}_{sample}_{unit}_fastp.tsv"
    run:
...
rule fastqc2:
    ...
    output:
          tmp_dir=directory(path_data + "raw_read_qc/fastqc2/{case}/{sample}/{case}_{sample}_{unit}_{qcpipe}/"),
          html1=path_data + "raw_read_qc/{qcpipe}_fastqc2/{case}/{sample}/{case}_{sample}_{unit}_{qcpipe}_fastqc2_1.html",
          html2=path_data + "raw_read_qc/{qcpipe}_fastqc2/{case}/{sample}/{case}_{sample}_{unit}_{qcpipe}_fastqc2_2.html",
          zip1=path_data + "raw_read_qc/{qcpipe}_fastqc2/{case}/{sample}/{case}_{sample}_{unit}_{qcpipe}_fastqc2_1.zip",
          zip2=path_data + "raw_read_qc/{qcpipe}_fastqc2/{case}/{sample}/{case}_{sample}_{unit}_{qcpipe}_fastqc2_2.zip"
    log:
       path_log + "raw_read_qc/{qcpipe}_fastqc2/{case}/{sample}/{case}_{sample}_{unit}_{qcpipe}_fastqc2.log"
    threads: config["threads"]["fastqc"]
    params:
          path=path_fastqc,
          extra=""
    benchmark:
             path_bm + "raw_read_qc/{qcpipe}_fastqc2/{case}/{sample}/{case}_{sample}_{unit}_{qcpipe}_fastqc2.tsv"
    run:
        if not os.path.exists(output.tmp_dir):
            shell("mkdir {output.tmp_dir}")
...
rule multiqc:
    input:
         expand([path_data + "raw_read_qc/fastqc/{u.case}/{u.sample}/{u.case}_{u.sample}_{u.unit}_1_fastqc.zip"],
                u=caseinfo.itertuples()),
         expand([path_data + "raw_read_qc/fastqc/{u.case}/{u.sample}/{u.case}_{u.sample}_{u.unit}_2_fastqc.zip"],
                u=caseinfo.itertuples()),
         expand([
